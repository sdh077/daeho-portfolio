...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('sdh077@naver.com')
    setCopied(true)
  }
  return (
    <div
      ...
      style={{
        ...
        backgroundColor: 'linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(75,9,121,1) 35%, rgba(0,212,255,1) 100%);'
      }}
    >
        ...
        >
          ...
          {id === 6 && (
            <div className="mt-5 relative">
              ...
              <MagicButton
                title={copied ? 'Email copied' : 'sdh077@naver.com'}
                icon={<IoCopyOutline />}
                position="left"
