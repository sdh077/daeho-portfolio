...
const CollectionCard = ({ collectionData }: { collectionData: Collection }) => {
  return (
    <section className='container mt-10 flex flex-col gap-8'>
      <h2 className="w-full pl-4 mx-auto text-xl md:text-4xl font-bold text-neutral-800 text-center">{collectionData.title}</h2>
      <h4 className='text-[#939393] text-center mt-1'>{collectionData.subtitle}</h4>
